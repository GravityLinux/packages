# Control the release manually for COPR
%global baserelease 15

# Control release version and whether this is development release or not
%if 0%{?fc44}
...
%define is_development 0
%elif 0%{?fc42}
%define release_name Forty Two [Adams]
%define dist_codename adams
%define is_rawhide 0
%define is_development 0
%elif 0%{?fc41}
%define release_name Forty One
%define is_rawhide 0
%define is_development 0
%elif 0%{?fc40}
...
%bcond lxqt 0
%bcond budgie 0
%bcond budgie_atomic 0
%bcond sway 0
%bcond sway_atomic 0
%bcond mobility 0
%bcond miraclewm 0
%bcond miraclewm_atomic 0
%bcond cosmic 0
%bcond cosmic_atomic 0
%bcond wsl 0
...
%global dist .fc%{dist_version}

# Changes should be submitted as pull requests under
#     https://pagure.io/GravityLinux/gravity-release

Summary:        Gravity Linux release files
...
License:        MIT
URL:            https://pagure.io/GravityLinux/project
...
Provides:       gravity-release = %{version}-%{release}
Provides:       gravity-release-variant = %{version}-%{release}

Provides:       system-release
Provides:       system-release(%{version})
Requires:       gravity-release-common = %{version}-%{release}

# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-basic if nothing else is already doing so.
Recommends:     gravity-release-identity-basic
...
%description
Gravity Linux release files such as various /etc/ files that define the release
...
Requires:   gravity-release-variant = %{version}-%{release}
Suggests:   gravity-release
...
%endif
Requires:   gravity-release-identity = %{version}-%{release}
...
# easier, but it cannot coexist with the gravity-release[-*] packages, so we
...
Summary:        Package providing the basic Gravity Linux identity

RemovePathPostfixes: .basic
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
...
Provides the necessary files for an Gravity Linux installation that is not identifying
...
%if %{with cinnamon}
%package cinnamon
Summary:        Base package for Gravity Linux Cinnamon-specific default configurations
...
# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-cinnamon if nothing else is already doing so.
Recommends:     gravity-release-identity-cinnamon


%description cinnamon
Provides a base package for Gravity Linux Cinnamon-specific configuration files to
depend on as well as Cinnamon system defaults.


%package identity-cinnamon
Summary:        Package providing the identity for Gravity Linux Cinnamon Spin

RemovePathPostfixes: .cinnamon
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-cinnamon = %{version}-%{release}
...
Provides the necessary files for an Gravity Linux installation that is identifying
itself as Gravity Linux Cinnamon.
%endif


%if %{with cloud}
%package cloud
Summary:        Base package for Gravity Linux Cloud-specific default configurations
...
# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-cloud if nothing else is already doing so.
Recommends:     gravity-release-identity-cloud


%description cloud
Provides a base package for Gravity Linux Cloud-specific configuration files to
depend on.


%package identity-cloud
Summary:        Package providing the identity for Gravity Linux Cloud Edition

RemovePathPostfixes: .cloud
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-cloud = %{version}-%{release}
...
Provides the necessary files for an Gravity Linux installation that is identifying
itself as Gravity Linux Cloud Edition.
%endif


%if %{with compneuro}
%package compneuro
Summary:        Base package for Gravity Linux Comp Neuro specific default configurations
...
# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-compneuro if nothing else is already doing so.
Recommends:     gravity-release-identity-compneuro


%description compneuro
Provides a base package for Gravity Linux Comp Neuro specific configuration files to
depend on as well as Comp Neuro system defaults.


%package identity-compneuro
Summary:        Package providing the identity for Gravity Linux Comp Neuro Lab

RemovePathPostfixes: .compneuro
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-compneuro = %{version}-%{release}
...
Provides the necessary files for an Gravity Linux installation that is identifying
itself as Gravity Linux Comp Neuro Lab.
%endif


%if %{with container}
%package container
Summary:        Base package for Gravity Linux container specific default configurations
...
# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-container if nothing else is already doing so.
Recommends:     gravity-release-identity-container


%description container
Provides a base package for Gravity Linux container specific configuration files to
depend on as well as container system defaults.


%package identity-container
Summary:        Package providing the identity for Gravity Linux Container Base Image

RemovePathPostfixes: .container
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-container = %{version}-%{release}
...
%if %{with coreos}
%package coreos
Summary:        Base package for Gravity Linux CoreOS-specific default configurations
...
# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-coreos if nothing else is already doing so.
Recommends:     gravity-release-identity-coreos


%description coreos
Provides a base package for Gravity Linux CoreOS Host-specific configuration files to
depend.


%package identity-coreos
Summary:        Package providing the identity for Gravity Linux CoreOS

RemovePathPostfixes: .coreos
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-coreos = %{version}-%{release}
...
Provides the necessary files for an Gravity Linux installation that is identifying
itself as Gravity Linux CoreOS.
%endif


%if %{with designsuite}
%package designsuite
Summary:        Base package for Gravity Linux Design Suite specific default configurations
...
# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-designsuite if nothing else is already doing so.
Recommends:     gravity-release-identity-designsuite


%description designsuite
Provides a base package for Gravity Linux Design Suite specific configuration files to
depend on.


%package identity-designsuite
Summary:        Package providing the identity for Gravity Linux Design Suite Lab

RemovePathPostfixes: .designsuite
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-designsuite = %{version}-%{release}
...
Provides the necessary files for an Gravity Linux installation that is identifying
itself as Gravity Linux Design Suite Lab.
%endif


%if %{with eln}
%package eln
Summary:        Base package for Gravity Linux ELN specific default configurations
...
# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-eln if nothing else is already doing so.
Recommends:     gravity-release-identity-eln


%description eln
Provides a base package for Gravity Linux ELN specific configuration files to
depend on.


%package identity-eln
Summary:        Package providing the identity for Gravity Linux ELN
...
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-eln = %{version}-%{release}
...
%if %{with iot}
%package iot
Summary:        Base package for Gravity Linux IoT specific default configurations
...
# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-iot if nothing else is already doing so.
Recommends:     gravity-release-identity-iot


%description iot
Provides a base package for Gravity Linux IoT specific configuration files to
depend on as well as IoT system defaults.


%package identity-iot
Summary:        Package providing the identity for Gravity Linux IoT Edition

RemovePathPostfixes: .iot
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-iot = %{version}-%{release}
...
Provides the necessary files for an Gravity Linux installation that is identifying
itself as Gravity Linux IoT Edition.
%endif
...
# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-kde if nothing else is already doing so.
Recommends:     gravity-release-identity-kde
...
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-kde = %{version}-%{release}
...
%if %{with kde_mobile}
%package kde-mobile
Summary:        Base package for Gravity Linux KDE Plasma Mobile specific default configurations
...
Recommends:     gravity-release-identity-kde-mobile


%description kde-mobile
Provides a base package for Gravity Linux KDE Plasma Mobile specific configuration files to
depend on as well as KDE Plasma Mobile system defaults.


%package identity-kde-mobile
Summary:        Package providing the identity for Gravity Linux KDE Plasma Mobile Spin

RemovePathPostfixes: .kde-mobile
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-kde-mobile = %{version}-%{release}


%description identity-kde-mobile
Provides the necessary files for a Fedora installation that is identifying
itself as Gravity Linux KDE Plasma Mobile Spin.
%endif

%if %{with matecompiz}
%package matecompiz
Summary:        Base package for Gravity Linux MATE-Compiz-specific default configurations
...
# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-matecompiz if nothing else is already doing so.
Recommends:     gravity-release-identity-matecompiz


%description matecompiz
Provides a base package for Gravity Linux MATE-compiz-specific configuration files to
depend on as well as MATE-Compiz system defaults.


%package identity-matecompiz
Summary:        Package providing the identity for Gravity Linux MATE-Compiz Spin

RemovePathPostfixes: .matecompiz
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-matecompiz = %{version}-%{release}
...
Provides the necessary files for an Gravity Linux installation that is identifying
itself as Gravity Linux MATE-Compiz.
%endif


%if %{with server}
%package server
Summary:        Base package for Gravity Linux Server-specific default configurations
...
# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-server if nothing else is already doing so.
Recommends:     gravity-release-identity-server


%description server
Provides a base package for Gravity Linux Server-specific configuration files to
depend on.


%package identity-server
Summary:        Package providing the identity for Gravity Linux Server Edition

RemovePathPostfixes: .server
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-server = %{version}-%{release}
...
Provides the necessary files for an Gravity Linux installation that is identifying
itself as Gravity Linux Server Edition.
%endif


%if %{with silverblue}
%package silverblue
Summary:        Base package for Gravity Linux Silverblue-specific default configurations
...
Provides:       system-release(%{version})
Requires:       gravity-release-common = %{version}-%{release}
Requires:       gravity-release-ostree-desktop = %{version}-%{release}
...
# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-silverblue if nothing else is already doing so.
Recommends:     gravity-release-identity-silverblue


%description silverblue
Provides a base package for Gravity Linux Silverblue-specific configuration files to
depend on as well as Silverblue system defaults.


%package identity-silverblue
Summary:        Package providing the identity for Gravity Linux Silverblue

RemovePathPostfixes: .silverblue
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-silverblue = %{version}-%{release}


%description identity-silverblue
Provides the necessary files for an Gravity Linux installation that is identifying
itself as Gravity Linux Silverblue.
%endif


%if %{with kinoite}
%package kinoite
Summary:        Base package for Gravity Linux Kinoite-specific default configurations
...
# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-kinoite if nothing else is already doing so.
Recommends:     gravity-release-identity-kinoite


%description kinoite
Provides a base package for Gravity Linux Kinoite-specific configuration files to
depend on as well as Kinoite system defaults.


%package identity-kinoite
Summary:        Package providing the identity for Gravity Linux Kinoite

RemovePathPostfixes: .kinoite
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-kinoite = %{version}-%{release}
...
Provides the necessary files for an Gravity Linux installation that is identifying
itself as Gravity Linux Kinoite.
%endif

%if %{with kinoite_mobile}
%package kinoite-mobile
Summary:        Base package for Gravity Linux Kinoite Mobile specific default configurations
...
Obsoletes:      fedora-release-kinoite-mobile < 1:%{version}-%{release}
Provides:       fedora-release-kinoite-mobile = 1:%{version}-%{release}

# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-kinoite-mobile if nothing else is already doing so.
Recommends:     gravity-release-identity-kinoite-mobile


%description kinoite-mobile
Provides a base package for Gravity Linux Kinoite Mobile specific configuration files to
depend on as well as Kinoite Mobile system defaults.


%package identity-kinoite-mobile
Summary:        Package providing the identity for Gravity Linux Kinoite Mobile.

RemovePathPostfixes: .kinoite-mobile
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-kinoite-mobile = %{version}-%{release}

Obsoletes:      fedora-release-identity-kinoite-mobile < 1:%{version}-%{release}
Provides:       fedora-release-identity-kinoite-mobile = 1:%{version}-%{release}


%description identity-kinoite-mobile
Provides the necessary files for a Fedora installation that is identifying
itself as Gravity Linux Kinoite Mobile.
%endif
...
%if %{with snappy}
%package snappy
Summary:        Base package for Gravity Linux snap specific default configurations
...
# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-snappy if nothing else is already doing so.
Recommends:     gravity-release-identity-snappy


%description snappy
Provides a base package for Gravity Linux snap specific configuration files to
depend on as well as Snappy system defaults.


%package identity-snappy
Summary:        Package providing the identity for Gravity Linux Snappy environments

RemovePathPostfixes: .snappy
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-snappy = %{version}-%{release}
...
Provides the necessary files for an Gravity Linux installation that is identifying
itself as Gravity Linux's snappy environment.
%endif


%if %{with soas}
%package soas
Summary:        Base package for Gravity Linux Sugar on a Stick-specific default configurations
...
# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-soas if nothing else is already doing so.
Recommends:     gravity-release-identity-soas


%description soas
Provides a base package for Gravity Linux Sugar on a Stick-specific configuration
files to depend on as well as SoaS system defaults.


%package identity-soas
Summary:        Package providing the identity for Gravity Linux Sugar on a Stick

RemovePathPostfixes: .soas
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-soas = %{version}-%{release}
...
Provides the necessary files for an Gravity Linux installation that is identifying
itself as Gravity Linux Sugar on a Stick.
%endif


%if %{with toolbx}
%package toolbx
Summary:        Base package for Gravity Linux Toolbx container specific default configurations
...
Obsoletes:      fedora-release-toolbx < 1:%{version}-%{release}
Provides:       fedora-release-toolbx = 1:%{version}-%{release}

# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-toolbx if nothing else is already doing so.
Recommends:     gravity-release-identity-toolbx


%description toolbx
Provides a base package for Gravity Linux Toolbx container specific configuration files to
depend on as well as Toolbx container system defaults.


%package identity-toolbx
Summary:        Package providing the identity for Gravity Linux Toolbx container image

RemovePathPostfixes: .toolbx
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-toolbx = %{version}-%{release}

Obsoletes:      fedora-release-identity-toolbx < 1:%{version}-%{release}
Provides:       fedora-release-identity-toolbx = 1:%{version}-%{release}


%description identity-toolbx
Provides the necessary files for a Gravity Linux installation that is identifying
itself as the Gravity Linux Toolbx container image.
%endif

%if %{with workstation}
%package workstation
Summary:        Base package for Gravity Linux Workstation-specific default configurations
...
# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-workstation if nothing else is already doing so.
Recommends:     gravity-release-identity-workstation


%description workstation
Provides a base package for Gravity Linux Workstation-specific configuration files to
depend on.


%package identity-workstation
Summary:        Package providing the identity for Gravity Linux Workstation Edition

RemovePathPostfixes: .workstation
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-workstation = %{version}-%{release}
...
Provides the necessary files for an Gravity Linux installation that is identifying
itself as Gravity Linux Workstation Edition.
%endif


%if %{with xfce}
%package xfce
Summary:        Base package for Gravity Linux Xfce specific default configurations
...
# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-xfce if nothing else is already doing so.
Recommends:     gravity-release-identity-xfce


%description xfce
Provides a base package for Gravity Linux Xfce specific configuration files to
depend on as well as Xfce system defaults.


%package identity-xfce
Summary:        Package providing the identity for Gravity Linux Xfce Spin

RemovePathPostfixes: .xfce
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-xfce = %{version}-%{release}
...
Provides the necessary files for an Gravity Linux installation that is identifying
itself as Gravity Linux Xfce.
%endif


%if %{with i3}
%package i3
Summary:        Base package for Gravity Linux i3 specific default configurations
...
# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-i3 if nothing else is already doing so.
Recommends:     gravity-release-identity-i3


%description i3
Provides a base package for Gravity Linux i3 specific configuration files to
depend on.


%package identity-i3
Summary:        Package providing the identity for Gravity Linux i3 Spin

RemovePathPostfixes: .i3
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-i3 = %{version}-%{release}
...
Provides the necessary files for an Gravity Linux installation that is identifying
itself as Gravity Linux i3.
%endif


%if %{with lxde}
%package lxde
Summary:        Base package for Gravity Linux LXDE specific default configurations
...
Obsoletes:      fedora-release-lxde < 1:%{version}-%{release}
Provides:       fedora-release-lxde = 1:%{version}-%{release}

# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-lxde if nothing else is already doing so.
Recommends:     gravity-release-identity-lxde


%description lxde
Provides a base package for Gravity Linux LXDE specific configuration files to
depend on as well as LXDE system defaults.


%package identity-lxde
Summary:        Package providing the identity for Gravity Linux LXDE Spin

RemovePathPostfixes: .lxde
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-lxde = %{version}-%{release}

Obsoletes:      fedora-release-identity-lxde < 1:%{version}-%{release}
Provides:       fedora-release-identity-lxde = 1:%{version}-%{release}

%description identity-lxde
Provides the necessary files for a Gravity Linux installation that is identifying
itself as Gravity Linux LXDE.
%endif


%if %{with lxqt}
%package lxqt
Summary:        Base package for Gravity Linux LXQt specific default configurations
...
# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-lxqt if nothing else is already doing so.
Recommends:     gravity-release-identity-lxqt


%description lxqt
Provides a base package for Gravity Linux LXQt specific configuration files to
depend on as well as LXQt system defaults.


%package identity-lxqt
Summary:        Package providing the identity for Gravity Linux LXQt Spin

RemovePathPostfixes: .lxqt
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-lxqt = %{version}-%{release}
...
Provides the necessary files for an Gravity Linux installation that is identifying
itself as Gravity Linux LXQt.
%endif

%if %{with budgie}
%package budgie
Summary:        Base package for Gravity Linux Budgie specific default configurations
...
# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-budgie if nothing else is already doing so.
Recommends:     gravity-release-identity-budgie


%description budgie
Provides a base package for Gravity Linux Budgie specific configuration files to
depend on as well as Budgie system defaults.


%package identity-budgie
Summary:        Package providing the identity for Gravity Linux Budgie Spin

RemovePathPostfixes: .budgie
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-budgie = %{version}-%{release}
...
Provides the necessary files for an Gravity Linux installation that is identifying
itself as Gravity Linux Budgie.
%endif


%if %{with sway}
%package sway
Summary:        Base package for Gravity Linux Sway specific default configurations
...
# gravity-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-sway if nothing else is already doing so.
Recommends:     gravity-release-identity-sway


%description sway
Provides a base package for Gravity Linux Sway specific configuration files to
depend on.


%package identity-sway
Summary:        Package providing the identity for Gravity Linux Sway Spin

RemovePathPostfixes: .sway
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-sway = %{version}-%{release}
...
Provides the necessary files for an Gravity Linux installation that is identifying
itself as Gravity Linux Sway.
%endif


%if %{with sway_atomic}
%package sway-atomic
Summary:        Base package for Gravity Linux Sway Atomic specific default configurations
...
Obsoletes:      fedora-release-sway-atomic < 1:%{version}-%{release}
Provides:       fedora-release-sway-atomic = 1:%{version}-%{release}

# gravity-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-sway-atomic if nothing else is already doing so.
Recommends:     gravity-release-identity-sway-atomic

%description sway-atomic
Provides a base package for Gravity Linux Sway Atomic specific configuration
files to depend on.


%package identity-sway-atomic
Summary:        Package providing the identity for Gravity Linux Sway Atomic

RemovePathPostfixes: .sway-atomic
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-sway-atomic = %{version}-%{release}

Obsoletes:      fedora-release-identity-sway-atomic < 1:%{version}-%{release}
Provides:       fedora-release-identity-sway-atomic = 1:%{version}-%{release}

%description identity-sway-atomic
Provides the necessary files for a Gravity Linux installation that is identifying
itself as Gravity Linux Sway Atomic.
%endif

%if %{with budgie_atomic}
%package budgie-atomic
Summary:        Base package for Gravity Linux Budgie Atomic specific default configurations
...
Obsoletes:      fedora-release-budgie-atomic < 1:%{version}-%{release}
Provides:       fedora-release-budgie-atomic = 1:%{version}-%{release}

# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-budgie-atomic if nothing else is already doing so.
Recommends:     gravity-release-identity-budgie-atomic

%description budgie-atomic
Provides a base package for Gravity Linux Budgie Atomic specific configuration
files to depend on.


%package identity-budgie-atomic
Summary:        Package providing the identity for Gravity Linux Budgie Atomic

RemovePathPostfixes: .budgie-atomic
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-budgie-atomic = %{version}-%{release}

Obsoletes:      fedora-release-identity-budgie-atomic < 1:%{version}-%{release}
Provides:       fedora-release-identity-budgie-atomic = 1:%{version}-%{release}

%description identity-budgie-atomic
Provides the necessary files for a Gravity Linux installation that is identifying
itself as Gravity Linux Budgie Atomic.
%endif


%if %{with mobility}
%package mobility
Summary:        Base package for Gravity Linux Mobility specific default configurations
...
Obsoletes:      fedora-release-mobility < 1:%{version}-%{release}
Provides:       fedora-release-mobility = 1:%{version}-%{release}

# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-mobility if nothing else is already doing so.
Recommends:     gravity-release-identity-mobility


%description mobility
Provides a base package for Gravity Linux Mobility specific configuration
files to depend on.


%package identity-mobility
Summary:        Package providing the identity for Gravity Linux Mobility

RemovePathPostfixes: .mobility
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-mobility = %{version}-%{release}
...
Provides the necessary files for a Gravity Linux installation that is identifying
itself as Gravity Linux Mobility.
%endif

%if %{with miraclewm}
%package miraclewm
Summary:        Base package for Gravity Linux MiracleWM specific default configurations
...
Obsoletes:      fedora-release-miraclewm < 1:%{version}-%{release}
Provides:       fedora-release-miraclewm = 1:%{version}-%{release}

# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-miraclewm if nothing else is already doing so.
Recommends:     gravity-release-identity-miraclewm


%description miraclewm
Provides a base package for Gravity Linux Miracle Window Manager specific configuration
files to depend on.


%package identity-miraclewm
Summary:        Package providing the identity for Gravity Linux MiracleWM Spin

RemovePathPostfixes: .miraclewm
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-miraclewm = %{version}-%{release}

Obsoletes:      fedora-release-identity-miraclewm < 1:%{version}-%{release}
Provides:       fedora-release-identity-miraclewm = 1:%{version}-%{release}


%description identity-miraclewm
Provides the necessary files for a Fedora installation that is identifying
itself as Gravity Linux Miracle Window Manager.
%endif


%if %{with miraclewm_atomic}
%package miraclewm-atomic
Summary:        Base package for Gravity Linux MiracleWM Atomic specific default configurations
...
Obsoletes:      fedora-release-miraclewm-atomic < 1:%{version}-%{release}
Provides:       fedora-release-miraclewm-atomic = 1:%{version}-%{release}

# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-miraclewm-atomic if nothing else is already doing so.
Recommends:     gravity-release-identity-miraclewm-atomic


%description miraclewm-atomic
Provides a base package for Gravity Linux Miracle Window Manager Atomic specific
configuration files to depend on.


%package identity-miraclewm-atomic
Summary:        Package providing the identity for Gravity Linux MiracleWM Atomic

RemovePathPostfixes: .miraclewm-atomic
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-miraclewm-atomic = %{version}-%{release}

Obsoletes:      fedora-release-identity-miraclewm-atomic < 1:%{version}-%{release}
Provides:       fedora-release-identity-miraclewm-atomic = 1:%{version}-%{release}


%description identity-miraclewm-atomic
Provides the necessary files for a Fedora installation that is identifying
itself as Gravity Linux Miracle Window Manager Atomic.
%endif


%if %{with cosmic}
%package cosmic
Summary:        Base package for Gravity Linux COSMIC specific default configurations
...
Obsoletes:      fedora-release-cosmic < 1:%{version}-%{release}
Provides:       fedora-release-cosmic = 1:%{version}-%{release}

# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-cosmic if nothing else is already doing so.
Recommends:     gravity-release-identity-cosmic


%description cosmic
Provides a base package for Gravity Linux COSMIC specific configuration
files to depend on.


%package identity-cosmic
Summary:        Package providing the identity for Gravity Linux COSMIC Spin

RemovePathPostfixes: .cosmic
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-cosmic = %{version}-%{release}

Obsoletes:      fedora-release-identity-cosmic < 1:%{version}-%{release}
Provides:       fedora-release-identity-cosmic = 1:%{version}-%{release}


%description identity-cosmic
Provides the necessary files for a Gravity Linux installation that is identifying
itself as Gravity Linux COSMIC.
%endif


%if %{with cosmic_atomic}
%package cosmic-atomic
Summary:        Base package for Gravity Linux COSMIC Atomic specific default configurations
...
Obsoletes:      fedora-release-cosmic-atomic < 1:%{version}-%{release}
Provides:       fedora-release-cosmic-atomic = 1:%{version}-%{release}

# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-cosmic-atomic if nothing else is already doing so.
Recommends:     gravity-release-identity-cosmic-atomic


%description cosmic-atomic
Provides a base package for Gravity Linux COSMIC Atomic specific
configuration files to depend on.


%package identity-cosmic-atomic
Summary:        Package providing the identity for Gravity Linux COSMIC Atomic

RemovePathPostfixes: .cosmic-atomic
Provides:       gravity-release-identity = %{version}-%{release}
Conflicts:      gravity-release-identity
Requires(meta): gravity-release-cosmic-atomic = %{version}-%{release}

Obsoletes:      fedora-release-identity-cosmic-atomic < 1:%{version}-%{release}
Provides:       fedora-release-identity-cosmic-atomic = 1:%{version}-%{release}


%description identity-cosmic-atomic
Provides the necessary files for a Gravity Linux installation that is identifying
itself as Gravity Linux COSMIC Atomic.
%endif

%if %{with wsl}
%package wsl
Summary:        Base package for Gravity Linux WSL specific default configurations
...
Obsoletes:      fedora-release-wsl < 1:%{version}-%{release}
Provides:       fedora-release-wsl = 1:%{version}-%{release}

# gravity-release-common Requires: gravity-release-identity, so at least one
# package must provide it. This Recommends: pulls in
# gravity-release-identity-wsl if nothing else is already doing so.
Recommends:     gravity-release-identity-wsl


%description wsl
Provides a base package for Gravity Linux WSL specific configuration files to
depend on as well as WSL system defaults.


%package identity-wsl
Summary:        Package providing the identity for Gravity Linux WSL.
...
Obsoletes:      fedora-release-identity-wsl < 1:%{version}-%{release}
Provides:       fedora-release-identity-wsl = 1:%{version}-%{release}


%description identity-wsl
Provides the necessary files for a Gravity Linux installation that is identifying
itself as Gravity Linux WSL.
%endif
...
echo "Gravity Linux release %{version} (%{release_name})" > %{buildroot}%{_prefix}/lib/fedora-release
echo "cpe:/o:fedoraproject:gravity:%{version}" > %{buildroot}%{_prefix}/lib/system-release-cpe
...
%global dist_vendor Gravity Linux
%global dist_name   Gravity Linux
...
%global dist_home_url https://gravitylinux.org/

# Bugzilla / bug reporting URLs shown to users.
# Examples: gcc.spec
%global dist_bug_report_url https://github.com/GravityLinux/linux/issues
...
VERSION_CODENAME="%{?dist_codename}"
PRETTY_NAME="Gravity Linux %{dist_version} (%{release_name}%{?prerelease})"
ANSI_COLOR="0;38;2;60;110;180"
LOGO=gravity-logo-icon
DEFAULT_HOSTNAME="gravity"
HOME_URL="%{dist_home_url}"
DOCUMENTATION_URL="https://gravitylinux.org/"
SUPPORT_URL="https://github.com/GravityLinux/linux/issues"
...
- Derive Gravity KDE identity and defaults from Asahi release packaging
